...
public class ResultPage {
    ...
    public void verifyHigherPrice(int price){
        ...
        resultList.clear();
        //while condition is true, verify each page and save item price that is higher than expected
        ...
        //verify items on the last page. Save the item price that is higher than expected
